...
export default class AssessorService{
    static fetchAssessors = (page: number | string,projectId: any) => $api.get<AssessorResponse>(`/api/projects/${projectId}/assessors/?page=${page}&page_size=10`).then(res => res.data)
