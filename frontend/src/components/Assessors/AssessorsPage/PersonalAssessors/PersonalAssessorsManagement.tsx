...
// @ts-ignore
const PersonalAssessorsManagement = ({setShowRemoveAssessors, setShowChangeProject, availableChangeProject, availableAddProject, setShowAddProject}) => {
...
export default PersonalAssessorsManagement;