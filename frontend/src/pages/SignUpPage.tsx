...
const SignInPage = () => {
    const {register, setValue,getValues, handleSubmit, watch, formState: {errors}} = useForm<ISignUp>()
    useEffect(() => {
                            ...
                            <div className="my-2">
                                <div className='flex relative items-center'>
                                    ...
                                    <input {...register('password2')} type="password"
                                           name="password2" className="py-[12px] pl-[40px] w-full bg-[#F4F8F7] rounded-[8px] "
