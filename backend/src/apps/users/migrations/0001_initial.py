    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, max_length=255, validators=[core.utils.validators.allowed_chars_validator], verbose_name='фамилия')),
                ('first_name', models.CharField(blank=True, max_length=255, validators=[core.utils.validators.allowed_chars_validator], verbose_name='имя')),
                ('middle_name', models.CharField(blank=True, max_length=255, validators=[core.utils.validators.allowed_chars_validator], verbose_name='отчество')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_time', models.DateTimeField(default=apps.users.utils.common.create_expiration_date)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teamlead', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.baseuser', validators=[core.utils.validators.only_manager_validator], verbose_name='руководитель')),
