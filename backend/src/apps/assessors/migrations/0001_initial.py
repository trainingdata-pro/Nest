    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(max_length=255, validators=[core.utils.validators.allowed_chars_validator], verbose_name='фамилия')),
                ('first_name', models.CharField(max_length=255, validators=[core.utils.validators.allowed_chars_validator], verbose_name='имя')),
                ('middle_name', models.CharField(max_length=255, validators=[core.utils.validators.allowed_chars_validator], verbose_name='отчество')),
