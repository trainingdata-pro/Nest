...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='assessor',
            name='manager',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assessors', to='users.baseuser', validators=[core.utils.validators.only_manager_validator], verbose_name='менеджер'),
        ),
        migrations.AddField(
            model_name='assessor',
            name='projects',
